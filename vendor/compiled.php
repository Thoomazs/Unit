...
class Carbon extends DateTime
{
    ...
    public static function setLocale($locale)
    {
        ...
        static::translator()->addResource('array', require '/Users/Thomazs/Projects/Unit/vendor/nesbot/carbon/src/Carbon' . '/Lang/' . $locale . '.php', $locale);
    }
...
class EventServiceProvider extends ServiceProvider
{
    protected $listen = array('entity.created*' => array(LogEntitiesCreation::class), 'entity.updated*' => array(LogEntitiesUpdate::class), 'entity.deleted*' => array(LogEntitiesDeletion::class), 'illuminate.log' => array(LogToDatabase::class), 'auth.login' => array(TransferShoppingCartFromTempUser::class), UserWasRegistered::class => array(SendWelcomeEmail::class, LoginAfterRegistration::class));
    public function boot(DispatcherContract $events)
    {
        parent::boot($events);
    }
